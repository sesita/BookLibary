...
@section('content')
    ...
    <div class="container bg-white text-dark p-4 mt-4">
        ...
        @endif
        <form action="{{ route('admin.book.edit', $id) }}" method="post">
            @csrf
            @method('patch')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="status" name="status">
                    <option value="{{ $book->status }}"> - Leave this field like this to keep the same - </option>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="authors" name="authors" placeholder="Authors..." value="@foreach($book->authors as $author){{ $author->slug }},@endforeach">
